...
bool is_extension_supported(Arch arch, Extension ext) {
  static std::unordered_map<Arch, std::unordered_set<Extension>> arch2ext = {
      {Arch::x64,
       {Extension::sparse, Extension::pointer, Extension::async_mode,
        Extension::quant, Extension::data64, Extension::adstack,
      ...
      {Arch::cuda,
       {Extension::sparse, Extension::pointer, Extension::async_mode,
        Extension::quant, Extension::data64, Extension::adstack, Extension::bls,
        Extension::assertion}},
      {Arch::metal,
       {Extension::adstack, Extension::pointer, Extension::async_mode,
        Extension::assertion}},
